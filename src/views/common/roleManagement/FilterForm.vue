      ...
      <template slot="form">
        <el-row class="form-wrapper">
          <el-form :inline="true" :model="form" ref="form" class="demo-form-inline">
            <el-col :span="7">
              <el-form-item :label="$t('roleManagement.code')" prop="code">
                <el-input size="small" v-model.trim="form.code" placeholder="请输入关键字" maxlength="20"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="7">
              <el-form-item :label="$t('roleManagement.name')" prop="name">
            ...
            <transition name="fade-transform">
              <template v-if="showForm">
                <el-col :span="14" key="date">
                  <el-form-item label="添加时间" prop="createdTimeStart" class="datepicker">
                    <date-picker
                      :disabledDate="{
