<template>
  ...
  >
    ...
    <template slot="operation">
      <el-link type="primary" :underline="false" @click="view">查看</el-link>
      <el-link type="primary" :underline="false" @click="reply">回复</el-link>
...
export default {
    ...
    return {
      ...
      tableConfig: {
        ...
        headers: [
          ...
          { title: '发件人', field: 'send' },
          { title: '标题', field: 'title' },
          { title: '发送时间', field: 'time' },
  ...
  methods: {
    ...
    view() {
      this.$router.push('/innerMessage/detail')
    },
    reply() {
      this.$router.push('/innerMessage/reply')
    }
  }
}
</script>
