              ...
              <template v-if="showForm">
                <el-col :span="7" key="legalPerson">
                  <el-form-item label="法人代表：" prop="legalPerson">
                    <el-input size="small" v-model="form.legalPerson" placeholder="请输入关键字" maxlength="20"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="7" key="contactPhone">
                  <el-form-item label="联系电话：" prop="contactPhone">
                    <el-input size="small" v-model="form.contactPhone" placeholder="请输入关键字" maxlength="11"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="7" key="contactEmail">
                  <el-form-item label="电子邮箱：" prop="contactEmail">
                    <el-input size="small" v-model="form.contactEmail" placeholder="请输入关键字" maxlength="50"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="7" key="address">
                  <el-form-item label="地址：" prop="address">
                    <el-input size="small" v-model="form.address" placeholder="请输入关键字" maxlength="50"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="7" key="description">
                  <el-form-item label="备注：" prop="description">
                    <el-input size="small" v-model="form.description" placeholder="请输入关键字" maxlength="500"></el-input>
                  </el-form-item>
                </el-col>
